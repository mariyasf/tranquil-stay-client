...
const CustomerFeedbackCard = ({ feed }) => {
    const {
        imgUrl,
        message,
        name,
    ...
    return (
        <div className="">
            <section className="bg-white dark:bg-gray-900 w-full font-Poppins  mx-2">
                        ...
                        <div className="rating">
                            {
                                [1, 2, 3, 4, 5].map(num =>
                                    num <= rating ?
                                        ...
                                        : < input key={num}
                                            type="radio" name="rating-2" className="mask mask-star-2 bg-gray-300" />
